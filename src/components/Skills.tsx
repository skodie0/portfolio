        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-16 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {["Git", "REST APIs", "MongoDB", "Firebase", "Supabase", "Prisma", "Jest", "Cypress", "Figma", "Agile/Scrum"].map(
                (tech) => (
                  <span
                    key={tech}
                    className="px-4 py-2 rounded-full bg-secondary/50 border border-border/50 text-sm text-muted-foreground hover:text-primary hover:border-primary/50 transition-all duration-300 cursor-default"
                  >
                    {tech}
                  </span>
                )
