      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            {/* Description */}
            <p className="text-base md:text-lg text-muted-foreground/80 max-w-xl mx-auto lg:mx-0 mb-10 animate-slide-up" style={{ animationDelay: "0.3s" }}>
              I craft elegant digital experiences with clean code and modern technologies. 
              Passionate about building scalable applications that make a difference.
            </p>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-4 mb-8 animate-slide-up" style={{ animationDelay: "0.4s" }}>
            ...
            {/* Social Links */}
            <div className="flex items-center justify-center lg:justify-start gap-6 animate-slide-up" style={{ animationDelay: "0.5s" }}>
              <a
          ...
          <div className="order-1 lg:order-2 flex justify-center animate-fade-in" style={{ animationDelay: "0.3s" }}>
            <div className="relative">
              ...
              <img
                src={heroImage}
                alt="Abstract 3D geometric shapes representing software development"
                className="relative w-72 h-72 md:w-96 md:h-96 object-cover rounded-2xl border border-border/30 shadow-2xl animate-float"
              />
            </div>
          </div>
        </div>
